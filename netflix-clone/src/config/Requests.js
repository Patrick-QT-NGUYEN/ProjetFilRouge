...
// cle API ==> 029df0ffb4e5d73a9377a6dca8bd2060
...
const query ="&query=";
const search = " ";
const language = "&language=en-FR";

const requests = {
  fetchTrending: `${baseURL}/trending/all/week?api_key=${API_KEY}&language=en-FR`,
  fetchNetflixOriginals: `${baseURL}/discover/tv?api_key=${API_KEY}${language}&with_networks=213`,
  fetchTopRated: `${baseURL}/movie/top_rated?api_key=${API_KEY}&language=en-FR`,
  fetchActionMovies: `${baseURL}/discover/movie?api_key=${API_KEY}${language}&with_genres=28`,
  fetchComedyMovies: `${baseURL}/discover/movie?api_key=${API_KEY}${language}&with_generes=35`,
  fetchHorrorMovies: `${baseURL}/discover/movie?api_key=${API_KEY}${language}&with_generes=27`,
  fetchRomanceMovies: `${baseURL}/discover/movie?api_key=${API_KEY}${language}&with_generes=10749`,
  fetchDocumentaries: `${baseURL}/discover/movie?api_key=${API_KEY}${language}&with_generes=99`,
  upcoming: `${baseURL}/movie/upcoming?api_key=${API_KEY}${language}&with_generes=99`,
  ...
  latest: `${baseURL}/tv/latest?api_key=${API_KEY}&language=en-FR`,
  airing_today: `${baseURL}/tv/airing_today?api_key=${API_KEY}&language=en-FR`,
  on_the_air: `${baseURL}/tv/on_the_air?api_key=${API_KEY}&language=en-FR`,
